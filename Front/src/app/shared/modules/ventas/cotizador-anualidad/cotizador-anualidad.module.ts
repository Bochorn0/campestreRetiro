...
import { CotizadorAnualidadComponent } from './cotizador-anualidad.component';
@NgModule({
    ...
    declarations: [CotizadorAnualidadComponent],
    exports: [CotizadorAnualidadComponent]
})

export class CotizadorAnualidadModule {}