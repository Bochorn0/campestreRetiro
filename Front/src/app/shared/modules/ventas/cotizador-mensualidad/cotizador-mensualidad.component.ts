...
@Component({
    ...
    templateUrl: './cotizador-mensualidad.component.html',
    styleUrls: ['./cotizador-mensualidad.component.scss'],
    animations: [routerTransition()],
    providers: [VentasService]
})
export class CotizadorMensualidadComponent implements OnInit {
    ...
    enganche;acumuladoMen;fPrimeraAnualidad;totalFinal;numAnualidades;montoAnualidad;todosChkMensualidades;paginadoDatos;
    numPagosPagados;
    ...
    constructor(private ventasService: VentasService) {
        ...
        this.cotizacionMensualidades = this.numAnualidades = 0;this.paginadoDatos = 10;
...
//            this.totalMensual = 0;
        ...
        if(this.numPagosPagados > 0){
            this.cotizacionMensualidades.Datos.map(cm=> { if(cm.Pago <= this.numPagosPagados){
                cm.Pagado = true
                } 
            })
        }
