...
/***/ "./src/app/layout/reportes/reportes-routing.module.ts":
/*!************************************************************!*\
  !*** ./src/app/layout/reportes/reportes-routing.module.ts ***!
  \************************************************************/
...
/* harmony import */ var _reportes_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reportes.component */ "./src/app/layout/reportes/reportes.component.ts");
...
/***/ "./src/app/layout/reportes/reportes.component.html":
/*!*********************************************************!*\
  !*** ./src/app/layout/reportes/reportes.component.html ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./src/app/layout/reportes/reportes.component.ts":
/*!*******************************************************!*\
  !*** ./src/app/layout/reportes/reportes.component.ts ***!
  \*******************************************************/
...
var ReportesComponent = /** @class */ (function () {
    function ReportesComponent(estadisticasService) {
        this.estadisticasService = estadisticasService;
        this.idReporte = 0;
        this.fFin = moment__WEBPACK_IMPORTED_MODULE_3__(new Date()).format('YYYY-MM-DD');
        this.fInicio = moment__WEBPACK_IMPORTED_MODULE_3__(moment__WEBPACK_IMPORTED_MODULE_3__(new Date()).format('YYYY-MM') + "-01").format('YYYY-MM-DD');
    }
    ReportesComponent.prototype.generarReporte = function () {
        var _this = this;
        ...
        switch (this.idReporte) {
            case '1'://Reporte de Ventas
                this.estadisticasService.obtenerReporteVentas(Filtros).then(function (res) {
                    var datosOrdenados = _this._ordenarDatosVentas(res['Data']);
                    if (_this.datatableReportes != null) {
                        _this.datatableReportes._reiniciarRegistros({ Datos: res['Data'] });
                    }
                    _this.resultadoReporte = { Datos: res['Data'] };
                }).catch(function (err) { console.log('err', err); });
                break;
            case '2'://Reporte de Gastos
                this.estadisticasService.obtenerReporteGastos(Filtros).then(function (res) {
                    if (_this.datatableReportes != null) {
                        _this.datatableReportes._reiniciarRegistros({ Datos: res['Data'] });
                    }
                    _this.resultadoReporte = { Datos: res['Data'] };
            ...
            case '3'://Reporte de Nomina
                this.estadisticasService.obtenerReporteNomina(Filtros).then(function (res) {
                    _this.resultadoReporte = res['Data'];
                }).catch(function (err) { console.log('err', err); });
                break;
            case '4'://Reporte de Documentos
                this.estadisticasService.obtenerReporteDocumentos(Filtros).then(function (res) {
                    _this.resultadoReporte = res['Data'];
                }).catch(function (err) { console.log('err', err); });
                break;
            default://Nada
    ...
    ReportesComponent.prototype._ordenarDatosVentas = function (datos) {
        var dias = [];
        var Ordenados = [];
        datos.forEach(function (dat) {
            var dia = dat.Fecha_venta.split('T')[0];
            dias.push(dia);
        });
        var pordia = lodash__WEBPACK_IMPORTED_MODULE_4__["uniq"](dias);
        pordia.forEach(function (dia) {
            Ordenados.push({ Dia: dia, Datos: datos.filter(function (ob) { return ob.Fecha_venta.split('T')[0] == dia; }) });
        });
        console.log('por', Ordenados);
    };
    ReportesComponent.prototype.ngOnInit = function () { };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('datatableReportes'),
        __metadata("design:type", Object)
    ], ReportesComponent.prototype, "datatableReportes", void 0);
    ReportesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-reportes',
            template: __webpack_require__(/*! ./reportes.component.html */ "./src/app/layout/reportes/reportes.component.html"),
            styles: [__webpack_require__(/*! ./reportes.component.scss */ "./src/app/layout/reportes/reportes.component.scss")],
            animations: [Object(_router_animations__WEBPACK_IMPORTED_MODULE_1__["routerTransition"])()],
            providers: [_shared_services_estadisticas_service__WEBPACK_IMPORTED_MODULE_2__["EstadisticasService"]]
        }),
        __metadata("design:paramtypes", [_shared_services_estadisticas_service__WEBPACK_IMPORTED_MODULE_2__["EstadisticasService"]])
    ], ReportesComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _reportes_routing_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reportes-routing.module */ "./src/app/layout/reportes/reportes-routing.module.ts");
/* harmony import */ var _reportes_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reportes.component */ "./src/app/layout/reportes/reportes.component.ts");
...
var ReportesModule = /** @class */ (function () {
    ...
    ReportesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_reportes_routing_module__WEBPACK_IMPORTED_MODULE_1__["ReportesRoutingModule"], _shared__WEBPACK_IMPORTED_MODULE_3__["SharedModule"]],
            declarations: [_reportes_component__WEBPACK_IMPORTED_MODULE_2__["ReportesComponent"]]
        })
    ], ReportesModule);
